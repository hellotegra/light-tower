        ...
        <div>
          <div>
            <ul className="nav nav-pills nav-stacked">
                ...
                <li className="presentation"><Link to="/dashboard/efficiency"><i className="fa fa-map-signs" aria-hidden="true"></i><span className="hidden-xs hidden-sm">  Efficiency Steps</span></Link></li>
                <li className="presentation"><Link to="/dashboard/carbonstats"><i className="fa fa-leaf" aria-hidden="true"></i><span className="hidden-xs hidden-sm">  Carbon Stats</span></Link></li>
            </ul>
          </div>
        </div>
      );
